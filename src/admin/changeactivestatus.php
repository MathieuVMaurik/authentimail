...
if(isset($_POST['active']) && ($_POST['active'] == 0 || $_POST['active'] == 1) && (isset($_POST['userID']) && is_numeric($_POST['userID'])))
{
    $stmt = $db->prepare('UPDATE users SET active = :active WHERE ID = :userid');
